    ...
    <>
      ...
      <div className="max-w-sm mx-auto">
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          ...
          <form action="/api/auth/reset-password" method="post">
            <div className="space-y-4">
              <div>
                <label className="block text-sm text-gray-700 font-medium mb-1.5" htmlFor="email">
                  Email
                </label>
                <input
                  id="email"
              ...
              <div>
                <label className="block text-sm text-gray-700 font-medium mb-1.5" htmlFor="code">
                  Verification Code
                </label>
                <input
                  id="code"
              ...
              <div>
                <label className="block text-sm text-gray-700 font-medium mb-1.5" htmlFor="new-password">
                  New Password
                </label>
                <input
                  id="new-password"
            ...
            <div className="mt-6">
              <button
                className="w-full py-3 px-4 text-sm font-medium text-white bg-gray-900 rounded-full hover:bg-gray-800 transition disabled:cursor-not-allowed disabled:opacity-60"
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          ...
          <Link className="font-medium text-gray-900 hover:underline" href="/signin">
            Sign in
          </Link>
        </p>
      </div>
